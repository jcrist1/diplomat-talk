...
object DW {
    ...
    val lib: DiplomatWriteLib = Native.load("rustbasel", libClass)
...
internal class DiplomatJVMRuntime {
    companion object {
        ...
        val lib: DiplomatJVMRuntimeLib = Native.load("rustbasel", libClass, Collections.singletonMap(Library.OPTION_ALLOW_OBJECTS, true))
